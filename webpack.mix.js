...
mix.copyDirectory('resources/assets/admin/bootstrap/fonts', 'public/fonts');
mix.copyDirectory('resources/assets/admin/dist/fonts', 'public/fonts');
mix.copyDirectory('resources/assets/admin/dist/img', 'public/img');
